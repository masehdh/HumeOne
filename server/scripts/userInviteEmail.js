const template = function (messageBody, link) {
  let message = `
  <!doctype html>
  <html>
                    ...
                    <tr>
                      <td style="font-family: Montserrat, Helvetica; font-size: 14px; vertical-align: top;">
                        <img src="cid:humeone-email-banner" alt="Humeone Email Banner" height="auto"
                          ...
                          style="border:0; outline:none; text-decoration:none; display:block; margin-bottom: 16px;">
                        <h2
                              ...
                              <td align="left"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0"
                                  ...
                                  <tbody>
                                    <tr>
                                      <td
                                        style="font-family: Montserrat, Helvetica; font-size: 14px; vertical-align: top; background-color: #ff933a; background:linear-gradient(135deg, rgba(230,92,138,1) 0%, rgba(255,204,102,1) 100%); border-radius: 5px; text-align: center;">
                                        <a href="${link}" target="_blank"
                                          style="display: inline-block; color: #ffffff; background: linear-gradient(135deg, rgba(230,92,138,1) 0%, rgba(255,204,102,1) 100%); border: solid 1px #ffffff;  border-radius: 4px; box-sizing: border-box; cursor: pointer; text-decoration: none !important; font-size: 14px; font-weight: 600; ; margin: 0; padding: 8px 12px; text-transform: capitalize; border-color: #ffffff">View Details</a>
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
